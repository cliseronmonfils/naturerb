...
public class RecetteBallonement extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.recette_ballonement);
    ...
    private void moveToPage(Class obj){
        Intent intent = new Intent (RecetteBallonement.this, obj);
